            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" >
                  <h4 class="card-title ">Les réclamations concernant les absences </h4>
                  <p class="card-category" > </p>
                </div>
                <%   int ggg=(Integer) session.getAttribute("idgab");
         
              jibGroupe lo= new jibGroupe();
          ArrayList<ListeReclamation> l =lo.getReclt(ggg);
   %>
...
<td >    <form action="http://localhost:8080/gestion/lajoutAnswer?id=<%=list.getIdréc()%>" method="POST" >
              <textarea type="text" rows = "2" name ="answer" >
            Entrez votre réponse...
         </textarea>
      
         <button type="submit"  rel="tooltip" title="envoyer" class="btn btn-primary btn-link btn-sm" style="margin-top:-55px;margin-left:332px;color:#357a5b;">
