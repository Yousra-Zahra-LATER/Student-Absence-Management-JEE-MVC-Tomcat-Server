           ...
           <div class=" col-md-4">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  <div class="card-icon">
                   <i class=""><img src="../assets/ima/groups.png" ></i>
                
                  </div>
                  <p class="card-category">Réclamations concernant</p>
                  <h3 class="card-title">Les absences</h3>
                  </div>
                 <div class="card-footer">
                  <div class="stats">
                    <i class=""><img src="../assets/img/vis.PNG" ></i>
                  
                   <a href="http://localhost:8080/gestion/SABS?idg=<%=idbg%>">consulter les réclamations</a> 
            ...
            <div class=" col-md-4">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">Réclamations concernant</p>
                  <h3 class="card-title">Les Exclus</h3>
                  </div>
                 <div class="card-footer">
                  <div class="stats">
                   <i class=""><img src="../assets/img/vis.PNG" ></i>
                  
                   <a href="http://localhost:8080/gestion/SEXC?idg=<%=idbg%>">consulter les réclamations</a> 
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                ...
                <div class="card-body">
                 <img class="img" src="../assets/img/bibi25.jpg"style="width:290px;height:500px;margin-left: .5%;" />
                </div>
              </div>
            </div>
     </div>
