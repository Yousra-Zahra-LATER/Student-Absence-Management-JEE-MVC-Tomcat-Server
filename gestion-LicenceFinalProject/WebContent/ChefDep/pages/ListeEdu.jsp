          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <%   int ggg=(Integer) session.getAttribute("kk");
         
              jibGroupe lo= new jibGroupe();
          ArrayList<Etudiant> l =lo.getEtudiant(ggg);
   %>
			 ...
			 <% for(Etudiant list:l){ %> 
<tr>
<td><%= list.getIdetudiant()%></td>
<td><%=list.getNom() %></td>
<td><%=list.getPrenom()%></td>
<td><%=list.getEmail()%></td>
<td><%=list.getTéléphone()%></td>
<td><%=list.getAdresse()%></td>
<td><%=list.getAnneeBac()%></td>
<td><%=list.getForm() %></td>
<td><%=list.getNomg()%></td>
