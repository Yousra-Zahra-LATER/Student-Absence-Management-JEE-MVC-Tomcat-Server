 ...
 <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>   
        <div class="logo"><a class="simple-text logo-normal">
         ...
         <%
               	...
               	int idbg=(Integer)session.getAttribute("bg");
    		%>
        </a></div>
...
LocalDate localDate=localDateTime.toLocalDate();
      ...
      <div class="content">
       ...
       <%  
           ...
           int idmodule=(Integer)session.getAttribute("idmodule");
           
            Connection conn= (Connection)DriverManager.getConnection(url,user,passwd);
            Statement stmt=conn.createStatement();
           
            ResultSet rs1=stmt.executeQuery("select *  from exclus ex ,etudiant e where ex.idmodule="+idmodule+" and type='TD' and ex.idetudiant=e.idetudiant  "); //ramener tous le module et le type de la seance
           ...
           while(rs1.next()){
              %>
		    <tr>
			    <td> <%=rs1.getString("idetudiant") %> </td>
				<td> <%=rs1.getString("nom") %> </td>
			    <td> <%=rs1.getString("prénom") %> </td>
		     </tr>
          ...
          <% 
            ...
            ResultSet rs2=stmt.executeQuery("select *  from exclus ex ,etudiant e where ex.idmodule="+idmodule+" and type='TP' and ex.idetudiant=e.idetudiant  "); //ramener tous le module et le type de la seance
           ...
           while(rs2.next()){
              %>
		    <tr>
			    <td> <%=rs2.getString("idetudiant") %> </td>
          ...
          <%    Class.forName("com.mysql.jdbc.Driver");
            ...
            ResultSet rs3=stmt.executeQuery("select *  from exclus ex ,etudiant e where ex.idmodule="+idmodule+" and type='Cours' and ex.idetudiant=e.idetudiant  "); //ramener tous le module et le type de la seance
           ...
           while(rs3.next()){
              %>
		    <tr>
			    <td> <%=rs3.getString("idetudiant") %> </td>
				<td> <%=rs3.getString("nom") %> </td>
			    <td> <%=rs3.getString("prénom") %> </td>
		     </tr>
