                ...
                <% for (Formation f:lf){ %>
                  <li class="nav-item">
                    <a href="#<%=f.getIdFormation()%>" class="nav-link" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="<%=f.getIdFormation()%>">
                     ...
                     <%ArrayList <Integer> lg=hc.selectGroupe(f.getIdFormation()); %>
                      <ul class="nav nav-sm flex-column">
                     <%  for (Integer g:lg){ System.out.println(g);%>
                        <li class="nav-item">
...
LocalDate localDate=localDateTime.toLocalDate();
      ...
      <div class="content">
         ...
         System.out.println("eooo"+idgroupe);
          Connection conn= (Connection)DriverManager.getConnection(url,user,passwd);
          Statement stmt=conn.createStatement();
         
          ResultSet rs1=stmt.executeQuery("select * from module where idformation="+idformation);
      ...
      <div class=" col-md-4">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  <div class="card-icon">
                    <i class=""><img src="../assets/img/group.PNG" ></i> 
                  </div>
                  <p class="card-category"><%=rs1.getString("nom") %></p>
                  <h3 class="card-title"><%=rs1.getString("abréviation") %></h3>
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="http://localhost:8080/gestion/SafficherlisteExclusModule?idmodule=<%=  rs1.getInt("idmodule") %>&idgroupe=<%=idgroupe%>&iduser=${sessionScope.iduser}&name=${sessionScope.name}"><h4> Consulter la liste </h4></a>
                  </div>
                </div>
