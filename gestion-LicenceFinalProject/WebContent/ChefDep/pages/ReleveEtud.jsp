         ...
         <div class="container-fluid">
          <div class="row">
            ...
            %>
              ...
              <div class="card ">
                ...
                <div class="card-header card-header-primary" >
                  ...
                  <p class="card-category" ><%=rs1.getString("nom") %> <%= rs1.getString("prénom") %> </p>
                </div>
           ...
           while (rs2.next()){
               ...
               ResultSet rs3=stmt1.executeQuery("select * from séance where idséance="+rs2.getInt("idséance"));
           rs3.next();
           %>
		    <tr>
