            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" >
                  <h4 class="card-title ">La liste des étudiants et leurs justifications</h4>
                  <p class="card-category" > </p>
                </div>
                <%   int k=(Integer) session.getAttribute("k");
         
              jibGroupe lo= new jibGroupe();
          ArrayList<ListeJustification> l =lo.getJustif(k);
   %>
             ...
             <thead class=" text-primary">
                      ...
                      <tbody >
			 <% for(ListeJustification list:l){ %> 
<tr>
<td><%= list.getIdetu()%></td>
<td><%=list.getNom() %></td>
<td><%=list.getPrénom()%></td>
<td><%=list.getIdabs() %></td>
<td><%=list.getDateabs()%></td>
<td><%=list.getAbr()%></td>
<td><%=list.getType()%></td>
<%int idjus=list.getIdjus(); %>
 <td><div class="gallery"><a href="http://localhost:8080/gestion/cc.jsp?id=<%=idjus %>"><img src="http://localhost:8080/gestion/cc.jsp?id=<%=idjus %>" style="height:40px;"/>
</a></div>
</td>       
<td><%=list.getDjus()%></td>

<td class="td-actions text-right"><a href="http://localhost:8080/gestion/Saccpet?op=<%=list.getIdjus()%>"> <input type="button"  title="accepter"   class="btn btn-primary btn-link btn-sm">
              <i class=""><img src="../assets/ima/acc.png" style=" width: 24px;height: 24px;"></i></a></td>
<td class="td-actions text-right"><a href="http://localhost:8080/gestion/Sdelete?op=<%=list.getIdjus()%>"> <input type="button" title="refuser"   class="btn btn-primary btn-link btn-sm">
                <i class=""><img src="../assets/ima/del.png" style=" width: 24px;height: 24px;"></i></a></td>
</tr>
<%} %>
		 </tbody>
		</table>
