...
LocalDate localDate=localDateTime.toLocalDate();
            ...
            <div class="col-md-10 ml-auto mr-auto">
              <div class="card card-plain">
                <div class="card-header card-header-primary" >
                  <h4 class="card-title mt-10">La liste des exclus de mon groupe</h4>
       ...
       <%  ArrayList<ListeExclus> l=new ArrayList<ListeExclus> ();
         l=(ArrayList<ListeExclus>)session.getAttribute("liste");
        for(ListeExclus list:l){ %>
			...
			<tr>
			 ...
			 <td><%=list.getModule()%></td>
			 <td><%=list.getType()%></td>
			 <td><%=list.getAnswer()%></td>
				
						
		<% if(list.getIdetu()==opp){ %>
			<td >    <form action="http://localhost:8080/gestion/SreclamExclu?ab=<%=list.getIdexclu() %>&opp=<%=opp %>" method="POST" >
              <textarea type="text" rows = "2" name ="r"  >
            Entrez votre réclamation...
         </textarea>
      
         <button type="submit"  rel="tooltip" title="envoyer" class="btn btn-primary btn-link btn-sm" style="margin-top:-55px;margin-left:280px;color:#357a5b;">
