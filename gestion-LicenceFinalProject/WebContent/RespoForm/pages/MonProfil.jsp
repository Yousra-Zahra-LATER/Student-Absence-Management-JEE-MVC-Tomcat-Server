...
<body class="">
 ...
 <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>   
      ...
      <%
        ...
        int op=(Integer)session.getAttribute("id");
      ...
      <li class="nav-item ">
            <a class="nav-link" href="http://localhost:8080/gestion/SprofileRES?opp=${sessionScope.opid}"> 
              <i class=""><img src="../assets/img/ens.png" style=" width: 24px;height: 24px;"></i>
              <p>Gérer mon profil</p>
            </a>
          </li>
      <li class="nav-item">
              <a class="nav-link" href="http://localhost:8080/gestion/Sens?id=<%=op%>&name=<%=prenom%>">
                    <i class=""><img src="../assets/img/ens.png" style=" width: 24px;height: 24px;"></i>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="./homeRF.jsp">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form  action="http://localhost:8080/gestion/ModifMonR" method="POST">
...
<div class="inputWithIcon inputIconBg">
 ...
 <div class="inputWithIcon inputIconBg">
  ...
  <input type="text" name="form"value="${list.getForm()}"readonly>
             ...
             <a href="http://localhost:8080/gestion/SupR?opp=${sessionScope.opid}"type="submit" class="btn btn-primary pull-right">Supprimer</a>
