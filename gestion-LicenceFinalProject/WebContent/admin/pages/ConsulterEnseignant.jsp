    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >Espace Enseignant</a>
          </div>
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" >
                  <h4 class="card-title ">La liste des enseignants</h4>
		...
		<c:forEach var="list" items="${sessionScope.liste}">
			<tr>
			    <td><c:out value="${list.getIdenseignant()}"></c:out></td>
				<td><c:out value="${list.getNom()}"></c:out></td>
				<td><c:out value="${list.getPrenom()}"></c:out></td>
				<td><c:out value="${list.getGrade()}"></c:out></td>
				<td><c:out value="${list.getForm()}"></c:out></td>
				<td><c:out value="${list.getEmail()}"></c:out></td>
				<td class="td-actions "><a href="http://localhost:8080/gestion/AfficherEns?op=${list.getIdenseignant()}"> <input  type="button" rel="tooltip" title="afficher"  class="btn btn-primary btn-link btn-sm">
                <i style="color:green;  margin-left: -36%;"class="material-icons">portrait</i></a></td>
				<td class="td-actions text-right"><a href="http://localhost:8080/gestion/ConsModifEns?op=${list.getIdenseignant()}"> <input type="button" rel="tooltip" title="modifier"   class="btn btn-primary btn-link btn-sm">
                <i style="color:orange;margin-left: -33%;"class="material-icons">edit</a></td>
                <td class="td-actions text-right"><a href="http://localhost:8080/gestion/SupprimerEns?op=${list.getIdenseignant()}"> <input type="button" rel="tooltip" title="supprimer"  class="btn btn-primary btn-link btn-sm">
                <i style="color:red;margin-left: -36%;" class="material-icons">close</i></a></td>
