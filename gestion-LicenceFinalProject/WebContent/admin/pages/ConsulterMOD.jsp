    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >Espace Module</a>
          </div>
      ...
      <div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary" >
                  <h4 class="card-title ">La liste des modules</h4>
		...
		<c:forEach var="list" items="${sessionScope.liste}">
			<tr>
			    <td><c:out value="${list.getIdmodule()}"></c:out></td>
				<td><c:out value="${list.getNom()}"></c:out></td>
				<td><c:out value="${list.getAbréviation()}"></c:out></td>
				<td><c:out value="${list.getSpécialité()}"></c:out></td>
				
				<td class="td-actions text-right"><a href="http://localhost:8080/gestion/ConsModifMod?op=${list.getIdmodule()}"> <input type="button" rel="tooltip" title="modifier"   class="btn btn-primary btn-link btn-sm">
                <i style="color:orange;margin-left: -30%;"class="material-icons">edit</a></td>
                <td class="td-actions text-right"><a href="http://localhost:8080/gestion/SupprimerMOD?op=${list.getIdmodule()}"> <input type="button" rel="tooltip" title="supprimer"  class="btn btn-primary btn-link btn-sm">
                <i style="color:red;margin-left: -30%;" class="material-icons">close</i></a></td>
