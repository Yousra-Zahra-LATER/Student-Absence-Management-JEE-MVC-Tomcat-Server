            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                 ...
                 <div class="card-body">
<form  action="http://localhost:8080/gestion/ModifierMod" method="POST">
<c:forEach var="list" items="${sessionScope.liste}">

 <input type="hidden" name="id"  value="${list.getIdmodule()}" />
 ...
 <div class="inputWithIcon inputIconBg">
  ...
  <label for="abr"style="color:black;">abréviation:</label>
   <div class="inputWithIcon inputIconBg">
 <input type="text" name="abr" id="abr" value="${list.getAbréviation()}"/>
 ...
 <label for="spc"style="color:black;">spécialité:</label>
  ...
  <div class="bloc">
  <div class="select">
    <select name="spc" id="spc">

    <option value="${list.getSpécialité()}">${list.getSpécialité()} </option>
                 <%  while(R.next()){%> 	
