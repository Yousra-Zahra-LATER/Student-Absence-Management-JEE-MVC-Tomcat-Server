...
int opp=(Integer)session.getAttribute("i");
    		...
    		String idfor=session.getAttribute("idfor").toString();
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                 ...
                 <div class="card-body">
<form  action="http://localhost:8080/gestion/ModifierSEANCE?idfor=<%=idfor %>" method="POST">
<c:forEach var="list" items="${sessionScope.liste}">

<input type="hidden" name="id"  value="${list.getIdseance()}" />

<div class="row" style="padding: 13px 8px;">
                      <div class="col-md-6">
                        <div class="form-group">
                           <label for="heureD" style="color:black;">L'heure de début:</label>
                          <input type="time" name="heureD" id="heureD" value="${list.getHeureD()}"class="form-control">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                      <label for="heureD"style="color:black;">L'heure de fin:</label>
                          <input type="time" name="heureF" id="heureF"value="${list.getHeureF()}"class="form-control">
                        </div>
                      </div>
                    </div>
    ...
    <select  name="j">
      <option value="${list.getJour()}">${list.getJour()} </option>
    ...
    <select  name="t">
      <option value="${list.getType()}">${list.getType()} </option>
         ...
         <option  value="Cours">COURS</option>
                      ...
                      <div class="col-md-6">
                                <div class="form-group">
                         <label for="nom"style="color:black;">Salle/Amphi</label>
                 
<div class="inputWithIcon inputIconBg">
  <input type="text" name="s"value="${list.getSalle()}"/>
  ...
  <div class="select">
    <select name="g">
     ...
     <option  value="${list.getGroupe()}">${list.getGroupe()}</option>
     <option value="null">ne pas choisir</option>
      <%  while(R1.next()){%> 	
  ...
  <div class="select">
    <select name="m">
     <option  value="${list.getModule()}">${list.getModule()}</option>
      <%  while(R.next()){%> 	
  ...
  <div class="select">
    <select name="sc">
    <option value="${list.getSection()}">${list.getSection()}</option>
    <option value="null">ne pas choisir</option>
     <%  while(R7.next()){%> 	
