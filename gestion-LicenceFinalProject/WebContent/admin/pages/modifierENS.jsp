          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  <form  action="http://localhost:8080/gestion/ModifierEns" method="POST">
                    <c:forEach var="list" items="${sessionScope.liste}">
                <div class="row">
                      <div class="col-md-0">
                          
<input type="hidden" name="id" value="${list.getIdenseignant()}">
                        </div>
...
<div class="inputWithIcon inputIconBg">
  ...
  <div class="select">
    ...
    <select  name="cat">
       <option value="${list.getCatégorie()}">${list.getCatégorie()} </option>
  ...
  <div class="select">
    ...
    <select  name="g">
       <option value="${list.getGrade()}">${list.getGrade()} </option>
  ...
  <div class="select">
    ...
    <option value="${list.getForm()}">${list.getForm()} </option>
                 <%  while(R.next()){%> 	
