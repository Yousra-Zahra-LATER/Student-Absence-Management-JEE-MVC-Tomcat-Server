      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >Espace Module </a></br>
          </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h3 class="card-title">Espace Module</h3>
             ...
             <div id="slider" >
       <figure>
                  <img alt="cc" src="../assets/img/m1.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/m2.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/m3.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/m4.jpg"  style="height:400px;">  
                  <img alt="cc" src="../assets/img/m5.jpg" style="height:400px;">  
           </figure>
 </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="alert alert-info">
                   ...
                   <i style="color:#d3dbff" class="material-icons fa-fw fa-3x">folder_shared</i> 
                     ...
                     <a href="http://localhost:8080/gestion/ConsulterMOD">Consulter la liste des modules</a>
                  
                  </div>
                  <div class="alert alert-success">
                    
                   <i style="color:#d3de32" class="material-icons fa-fw fa-3x">create_new_folder</i> 
                     <a href="ajouterMOD.jsp">Ajouter un module</a>
