      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >Espace Séance</a></br>
          </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h3 class="card-title">Espace séance</h3>
             ...
             <div class="card-body">
                ...
                <div class="col-md-6">
                  ...
                  <div class="alert alert-info">
                   ...
                   <i style="color:#d3dbff" class="material-icons fa-fw fa-3x">folder_shared</i> 
                     ...
                     <a href="http://localhost:8080/gestion/ConsulterSEANCE">Consulter la liste des séances</a>
                  
                  </div>
                  <div class="alert alert-success">
                    
                   <i style="color:#d3de32" class="material-icons fa-fw fa-3x">create_new_folder</i> 
                     <a href="AjoutSeFor.jsp">Ajouter une séance</a>
              ...
              <div id="slider" >
       <figure>
                  <img alt="cc" src="../assets/img/eo5.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/eo1.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/eo2.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/eo3.jpg"  style="height:400px;">  
                  <img alt="cc" src="../assets/img/eo4.jpg" style="height:400px;">  
           </figure>
 </div>
