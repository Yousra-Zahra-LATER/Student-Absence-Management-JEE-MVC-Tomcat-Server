...
select option[value="STIW"] {
  background: #0FF219;
  color: white;
}
select option[value="STIC"] {
  background: #4DFF54;
  color: white;
}
*/
...
<body class="">
 ...
 <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>   
          ...
          <div class="row">
            <div class="col-md-10 ml-auto mr-auto" >
              <div class="card">
                ...
                <div class="card-body">
                   <form action="http://localhost:8080/gestion/SajoutEns" method="POST">
                      ...
                      <div class="col-md-3">
                       ...
                       <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input style="color:black;" type="date" oninput="result.value=send.value" name="dateN"class="form-control"required>
                        </div>
                      </div>
                     </div>
  ...
  <label class="bmd-label-floating" style="color:black;" >Sexe</label>
  <div class="form-check">
  <label class="form-check-label" style="color:#122B00;">
  <input type="checkbox" id="sexe" name="sexe" value="femme"  onclick="return se();" class="form-check-input">
   femme
  ...
  <label class="form-check-label"style="color:#122B00;">
  <input type="checkbox" id="sexe" name="sexe" value="homme" onclick="return se();" class="form-check-input" >
  ...
  homme
             <span class="form-check-sign" >
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label style="color:black;" >c'est un :</label>
                          <div class="bloc" >
  <div class="select">
    <select name="cr">
      <option  >Choisissez son travail ?</option>
      <option value="chef">Chef de département</option>
      <option value="res">Responsable de formation</option>
  ...
  <div class="select">
    <select  name="g">
      <option>Choisissez son grade?</option>
      ...
      <option value="PROFESSEUR">PROFESSEUR</option>
                      ...
                      Statement state;
                       ...
                       String q="SELECT abréviation from formation ";
                       ResultSet R =  state.executeQuery(q);
                    	 %>
                   
                      <div class="col-md-6">
                        <div class="form-group">
                          <label style="color:black;">Spécialité</label>
                          <div class="bloc">
  <div class="select">
    <select name="form">
     <option  >Choisissez sa spécialité ?</option>
                 <%  while(R.next()){%>
                	
                     <option value="<%=R.getString("abréviation") %>" style="background: #10C417;color: white;"><%=R.getString("abréviation") %></option>
                     <%  }  %>
...
Ali Mendjeli - BP : 67A, Constantine - Algérie.
  ...
  {  
    ...
    {  
        ...
        if(numberOfCheckedItems > 1)  
        {  
      	  swal("Désolé!", ", Vous devez cocher une seule", "error");
            return false;  
        }  
    }  
