      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top">
        <div class="container-fluid">
           <div class="navbar-wrapper">
            <a class="navbar-brand" >Espace Étudiant </a></br>
          </div>
...
<tr>
<td><c:out value="${list.getIdetudiant()}"></c:out></td>
...
<td class="td-actions "><a href="http://localhost:8080/gestion/AfficherETU?op=${list.getIdetudiant()}"> <input  type="button" rel="tooltip" title="afficher"  class="btn btn-primary btn-link btn-sm">
<i style="color:green;  margin-left: -36%;"class="material-icons">portrait</i></a></td>
<td class="td-actions text-right"><a href="http://localhost:8080/gestion/ConsModifEt?op=${list.getIdetudiant()}"> <input type="button" rel="tooltip" title="modifier"   class="btn btn-primary btn-link btn-sm">
<i style="color:orange;margin-left: -33%;"class="material-icons">edit</a></td>
<td class="td-actions text-right"><a href="http://localhost:8080/gestion/SupprimerET?op=${list.getIdetudiant()}"> <input type="button" rel="tooltip" title="supprimer"  class="btn btn-primary btn-link btn-sm">
