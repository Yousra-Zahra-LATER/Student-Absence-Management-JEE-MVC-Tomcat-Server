...
<head>
  ...
  <link href="../assets/css/espace.css?v=2.1.2" rel="stylesheet" />
    <link href="../assets/css/espetu.css?v=2.1.2" rel="stylesheet" />
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >Espace Enseignant </a></br>
          </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h3 class="card-title">Espace Enseignant</h3>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="alert alert-info">
                   ...
                   <i style="color:#d3dbff" class="material-icons fa-fw fa-3x">folder_shared</i> 
                    
                     <a href="http://localhost:8080/gestion/ConsulterEns">Consulter la liste des enseignant</a>
                  
                  </div>
                  <div class="alert alert-success">
                    
                   <i style="color:#d3de32" class="material-icons fa-fw fa-3x">create_new_folder</i> 
                     <a href="ajoutEns.jsp">Ajouter un enseignant</a>
                      ...
                      <div class="col-md-6">
                             ...
                             <div id="slider" >
       <figure>
                  <img alt="cc" src="../assets/img/b.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/y.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/s.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/etu1.jpg"  style="height:400px;">  
                  <img alt="cc" src="../assets/img/etu5.jpg" style="height:400px;">  
           </figure>
 </div>
