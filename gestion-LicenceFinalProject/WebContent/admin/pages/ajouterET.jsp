...
select option[value="L2"] {
  background: #12CC1C;
  color: white;
}
select option[value="L1"] {
  background: #15E81F;
  color: white;
}
          ...
          <div class="row">
            <div class="col-md-10 ml-auto mr-auto">
              <div class="card">
                ...
                <div class="card-body">
                   <form action="http://localhost:8080/gestion/lajoutETU" method="POST">
                 ...
                 <div class="row">
                   <div class="col-md-6">
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Année de bac</label>
                          <input type="number" name="annee"class="form-control"required>
                        </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Numéro de bac</label>
                          <input type="number" name="numbac"class="form-control"required>
                        </div>
                    </div>
                    </div>
                     <div class="row">
