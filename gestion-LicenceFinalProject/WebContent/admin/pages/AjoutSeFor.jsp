      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="">Espace Séance</a>
          </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-profile">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Choisissez d'abord une spécialité</h4>
                  <p class="card-description">
                  <form action="http://localhost:8080/gestion/Sform" method="POST">
                    <div class="col-md-12">
