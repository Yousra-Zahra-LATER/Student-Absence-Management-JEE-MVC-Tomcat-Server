      ...
      <div class="content">
		...
		<c:forEach var="list" items="${sessionScope.liste}">
			<tr>
				...
				<td><c:out value="${list.getDate_de_naissance()}"></c:out></td>
				<td><c:out value="${list.getEmail()}"></c:out></td>
				<td><c:out value="${list.getAdresse()}"></c:out></td>
				<td><c:out value="${list.getSexe()}"></c:out></td>
				<td><c:out value="${list.getTéléphone()}"></c:out></td>
				<td><c:out value="${list.getMotdepasse()}"></c:out></td>
		     	<td><c:out value="${list.getDescription()}"></c:out></td>
		     	<td><c:out value="${list.getCatégorie()}"></c:out></td>
