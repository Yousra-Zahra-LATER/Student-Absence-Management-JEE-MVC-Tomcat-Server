...
select option[value="SCI"] {
  background: #0AD113;
  color: white;
}
select option[value="RSD"] {
  background: #0ACC13;
  color: white;
}
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Modifier un étudiant</h4>
                  <p class="card-category">les informations</p>
                </div>
                <div class="card-body">
                  <form  action="http://localhost:8080/gestion/ModifierET" method="POST">
...
<div class="inputWithIcon inputIconBg">
  <input type="text" name="prenom"  value="${list.getPrenom()}"/>
  <i class="fa fa-user" aria-hidden="true"></i>
</div>
  ...
  <div class="select">
    ...
    <select  name="sexe">
      <option value="${list.getSexe()}">${list.getSexe()} </option>
                     ...
                     <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="inputWithIcon inputIconBg">
                          <input type="text" name="annee"value="${list.getAnneeBac()}">
                          <i class="fa fa-phone" aria-hidden="true"></i>
                        </div>
                      </div>
                      </div>
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="inputWithIcon inputIconBg">
                          <input type="text" name="numbac"value="${list.getNumBac()}">
                          <i class="fa fa-phone" aria-hidden="true"></i>
                        </div>
                    </div>
                    </div>
  ...
  <div class="bloc">
  <div class="select">
    <select name="form" id="spc">
    
       <%  while(R.next()){%> 	
      
    
      <option value="<%=R.getString("abréviation") %>" style="background: #0F9415;
  color: white;"><%=R.getString("abréviation") %></option>
                     <%  }  %>
    </select>
  </div>
