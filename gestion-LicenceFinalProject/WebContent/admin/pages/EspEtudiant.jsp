        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h3 class="card-title">Espace Étudiant </h3>
             ...
             <div id="slider" >
       <figure>
                  <img alt="cc" src="../assets/img/ea.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/ae.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/ee.jpg" style="height:400px;">  
                  <img alt="cc" src="../assets/img/p.jpg"  style="height:400px;">  
                  <img alt="cc" src="../assets/img/eaa.jpg" style="height:400px;">  
           </figure>
 </div>
                ...
                <div class="col-md-6">
                  ...
                  <div class="alert alert-info">
                   ...
                   <i style="color:#d3dbff" class="material-icons fa-fw fa-3x">folder_shared</i> 
                     ...
                     <a href="http://localhost:8080/gestion/ConsulterET">Consulter la liste des étudiants</a>
                  
                  </div>
                  <div class="alert alert-success">
                    
                   <i style="color:#d3de32"class="material-icons fa-fw fa-3x">create_new_folder</i> 
                     <a href="ajouterET.jsp">Ajouter un étudiant</a>
