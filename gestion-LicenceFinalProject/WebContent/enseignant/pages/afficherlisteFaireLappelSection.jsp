    ...
    <div class="main-panel">
      ...
      <div class="content">
          ...
          <div class="row">
           ...
           <div class="col-md-8  ml-auto mr-auto">
             ...
             <thead class=" text-primary">
                      ...
                      <tbody>
                    <%int  S=(Integer)session.getAttribute("idseance"); %>
               <form action="http://localhost:8080/gestion/SrecupererReleveSection?idseance=<%=S%>" method="POST">
                 <%
                        int idsection=(Integer)session.getAttribute("idsection") ;
                        ...
                        ResultSet rs1=stmt.executeQuery("select * from groupe g where idsection="+idsection);
                     ...
                     ArrayList<Integer> listeg= new  ArrayList<Integer>();
                       ...
                       listeg.add(idg);
                        ArrayList<Etudiant> l=g.ConsulterLeGroupe(idg);
			...
			<tr>
				...
				<td><div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input"  type="checkbox" name="absence" value="<%=  e.getIdetudiant()%>">
		...
		<input type="hidden" name="idsection" value="<%=idsection %>">
                <input class="btn btn-primary btn-round" type="submit" value="submit"></td>
                <td></td>
                </form>
		 </tbody>
