...
<head>
  ...
  <title>
  Consulter la liste des étudiant
  </title>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >Liste des etudiants</a></br>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
           ...
           int  idm=(Integer)session.getAttribute("idmodule");
          ...
          ResultSet rs1=stmt.executeQuery(" select DISTINCT idgroupe ,idsection  from séance   where idenseignant="+idens+" and idmodule="+idm+" and type='"+type+"'" );
           ...
           <div class="col-md-10  ml-auto mr-auto">
              <div class="card">
                <div class="card-header card-header-primary" >
                  <h4 class="card-title ">La liste des étudiants</h4>
             ...
             <thead class=" text-primary">
                        ...
                        <th>Nombre des justifications</th>
                        <th></th>
                      </thead>
	<form action="http://localhost:8080/gestion/SrecupererlisteExclus?idmodule=<%= idm %>&type=<%= type %>&iduser=${sessionScope.iduser}&name=${sessionScope.name}" method="POST">
	               <tbody>
                     
                      <% while(rs1.next()){ 
                    	  ArrayList<Etudiant> lE=new ArrayList<Etudiant>();
                    	  
               if(   rs1.getInt("idsection")!=0){
            	   mesgroupes g= new mesgroupes();
            	   ArrayList<Groupe> lg =f.selectionnergroupedunesection(rs1.getInt("idsection"));
            	  
            	     for (Groupe gr:lg) {
       				
       				lE.addAll(g.ConsulterLeGroupe(gr.getIdgroupe()));}
                     ...
                     lE=l.ListeEtud(rs1.getInt("idgroupe"));}
                      
                      
                     for(Etudiant e:lE){
                    	 ArrayList<Integer> i=l.ListeSeance(idens,idm, type);
                    	  int x=0;
                    	  int y=0;
                    	  for(Integer i1 :i){
                    		  
                    		 
                    		  x=x+l.NombreAbsence(i1.intValue(), e.getIdetudiant());
                    		  y=y+l.NombreJustification(i1.intValue(), e.getIdetudiant());
			...
			<tr>
			<%if(rs1.getInt("idgroupe")!=0){ %>
			    <td><%=h.selectionGroupe(rs1.getInt("idgroupe"))%></td>
			   <%}else{ %> 
			    <td><%=h.selectionGroupe(e.getIdgroupe()) %></td><%} %>
			    <td><%=e.getNom() %></td>
			    <td><%=e.getPrenom() %></td>
				...
				<td><div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input"  type="checkbox" name="exclus" value="<%=e.getIdetudiant()%>">
		...
		<td>
                ...
                <input class="btn btn-primary btn-round" type="submit" value="ajouter a la liste des exlus"></td>
                <td></td>
                <td></td>
