...
/*R̩initilaisation de la liste d̩roulante*/
select {
  appearance: none;
  outline: 0;
  border: 0 !important;
          ...
          <div class="row">
            <div class="col-md-8 ml-auto mr-auto">
              <div class="card">
                ...
                <div class="card-body">
                  <form  action="http://localhost:8080/gestion/SmodifierProfilENS?iduser=${sessionScope.id}&name=${sessionScope.name}" method="POST">
...
<div class="inputWithIcon inputIconBg">
  <input type="text" type="text" name="prenom"  value="${list.getPrenom()}"readonly/>
  <i class="fa fa-user" aria-hidden="true"></i>
</div>
        ...
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
           Copyright &copy;
            ...
            <a >Universit̩ Abdelhamid Mehri - Constantine 2. Tous les droits sont r̩serv̩s.
        </div>
      </footer>
    </div>
  </div>
