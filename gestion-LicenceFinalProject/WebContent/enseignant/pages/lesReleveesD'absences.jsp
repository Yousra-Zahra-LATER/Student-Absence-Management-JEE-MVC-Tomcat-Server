    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="container-fluid">
          <div class="row">
           <%  ArrayList<Groupe> l= new ArrayList<Groupe> ();
            l=(ArrayList<Groupe>)session.getAttribute("liste");
        ...
        for (Groupe g : l){
           ...
           ResultSet rs2=stmt.executeQuery("select max(date) from absence");
           rs2.next();
           String date =rs2.getString("max(date)");
            ResultSet rs1=stmt.executeQuery("select * from etudiant e,absence a where idgroupe="+g.getIdgroupe()+" and e.idetudiant = a.idetudiant and a.date in (select max(date) from absence)");
           ...
           <div class="col-md-12">
              ...
              <div class="card card-plain">
                ...
                <div class="card-header card-header-primary" >
                  <h4 class="card-title "> <%=h.selectionGroupe(g.getIdgroupe()) %>  </h4>
                  <p class="card-category" > Les absences du <%=date%></p>
                </div>
            ...
            Seance s= L.selectionnerSeance1(rs1.getInt("idséance"));
             
             %>
		    <tr>
			    <td> <%=rs1.getInt("idetudiant") %> </td>
		    ...
		    <%} %>
		     <tr>
                          ...
                          <td class="text-center"></td>
                          <td >
                            <a  href="http://localhost:8080/gestion/Slistedungroupe?op=<%= g.getIdgroupe() %>&iduser=${sessionScope.iduser}&name=${sessionScope.name}" class="btn btn-round btn-fill btn-info">Afficher la suite</a>
                          </td>
                        </tr>
            </tbody>
