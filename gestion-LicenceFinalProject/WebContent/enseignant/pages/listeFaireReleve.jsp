 ...
 <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>   
    ...
    <div class="main-panel">
      ...
      <div class="content">
          ...
          <div class="row">
           ...
           <div class="col-md-8  ml-auto mr-auto">
             ...
             <thead class=" text-primary">
                      ...
                      %>
               <form action="http://localhost:8080/gestion/SrecupererReleve?idseance=<%=S%>&iduser=${sessionScope.iduser}&name=${sessionScope.name}" method="POST">
			...
			<tr>
				...
				<td><div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input"  type="checkbox" name="absence" value="${list.getIdetudiant()}">
		...
		<input type="hidden" name="idgroupe" value="${sessionScope.idgroupe}">
