...
<body class="">
 ...
 <li class="nav-item d-none d-md-block"><a class="nav-link sidebartoggler waves-effect waves-light" href="javascript:void(0)" data-sidebartype="mini-sidebar"><i class="mdi mdi-menu font-24"></i></a></li>   
        ...
        <ul class="nav">
         ...
         width: 24px;
          height: 24px; " ></i>
              <p>Etablir la liste des exclus</p>
            </a>
          </li>
             ...
             <form class="navbar-form">
              <div class="input-group no-border">
                ...
                <button type="submit" class="btn btn-white btn-round btn-just-icon">
                 <i class=""><img src="../assets/img/search.png" style=" width: 24px;height: 24px;"></i>
        ...
        <div class="container-fluid">
          <div class="row">
           ...
           HomeENS h= new HomeENS ();
            ...
            ResultSet rs1=stmt.executeQuery("select * from séance e, absence a where idgroupe="+idgroupe+" and e.idséance= a.idséance order by (date) desc "); //ramener tous le module et le type de la seance
           ...
           <div class="col-md-12">
              ...
              <div class="card card-plain">
                ...
                <div class="card-header card-header-primary" >
                  <h4 class="card-title "> <%=h.selectionGroupe(idgroupe) %></h4>
		    ...
		    <tr>
			    ...
			    <td> <%=L.SelectionnerModule(rs1.getInt("idmodule")) %> </td>
			    <td> <%=rs1.getString("type") %> </td>
			    <td> <%=rs1.getString("heureD") %> </td>
			    <td> <%=rs1.getString("heureF") %> </td>
			    <td><%=rs1.getString("date") %></td>
			    <td><a class="nav-link" href="http://localhost:8080/gestion/SRelevedunEtud?op=<%= rs2.getInt("idetudiant") %>&iduser=${sessionScope.iduser}&name=${sessionScope.name}"  class="btn btn-round btn-fill btn-info">
                                <i class=""><img src="../assets/img/per.PNG" ></i> </a>
	       ...
	       try{
	         ...
	         Connection conn2= (Connection)DriverManager.getConnection(url,username,password);
	        
            Statement stmt2=conn2.createStatement();
           ResultSet rs=stmt2.executeQuery("select idsection  from groupe where idgroupe="+idgroupe);
           rs.next();
           ResultSet rs3=stmt2.executeQuery("select * from séance e, absence a where idsection="+rs.getInt("idsection")+" and e.idséance= a.idséance order by (date) desc ");
		    ...
		    <tr>
				...
				<td> <%=rs2.getString("nom") %> </td>
			    <td> <%=rs2.getString("prénom") %> </td>
			    <td> <%=L.SelectionnerModule(rs3.getInt("idmodule")) %> </td>
