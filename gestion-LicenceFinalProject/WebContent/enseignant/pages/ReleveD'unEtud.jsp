        ...
        <div class="container-fluid">
          ...
          <div class="row">
           ...
           HomeENS h= new HomeENS ();
            ...
            ResultSet rs1=stmt.executeQuery("select * from etudiant where idetudiant="+idetudiant);
        ...
        <div class="col-md-6 ml-auto mr-auto">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                   <i class=""><img src="../assets/img/round_account_circle_black_48dp.png"  ></i>
                  </a>
                </div>
                <div class="card-body">
             ...
             %>
                 <h4> <strong>Nom :</strong>  <%= rs1.getString("nom") %> </br>
                  <strong>Prénom :</strong>  <%= rs1.getString("prénom") %></br>
                  <strong>date de naissance :</strong>  <%=  rs1.getString("datedenaissance") %></br>
                  <strong>Email :</strong>  <%=rs1.getString("email") %></br>
                  <strong>Téléphone :</strong> <%=rs1.getString("téléphone") %>
                   </h4>
                  </p>
            ...
            <tbody>  
           <%  ResultSet rs2=stmt.executeQuery("select * from absence where idetudiant="+idetudiant);
           while (rs2.next()){
        	   Seance s= L.selectionnerSeance1(rs2.getInt("idséance"));
           
           %>
		    <tr>
			 
			    <td> <%=L.SelectionnerModule(s.getIdmodule()) %> </td>
			    <td><%=s.getType() %></td>
			    <td> <%=s.getHeureD() %> </td>
			    <td> <%=s.getHeureF() %> </td>
			    <%if(L.etatjustification(rs2.getInt("idjustification"))==1) {%>
			     <td >Acceptée</td>
			     
			    <%} if(L.etatjustification(rs2.getInt("idjustification"))==2) {%>
			     <td >En attente</td><%}else{ %>
			     <td >Refusée</td><%} %>
			     
			     <td><%= rs2.getString("date") %></td>
			    
			<td> <a class="nav-link" href="http://localhost:8080/gestion/SsupprimerAbsence?op=<%= rs2.getInt("idabsence") %>&iduser=${sessionScope.iduser}&name=${sessionScope.name}"  class="btn btn-round btn-fill btn-info">
                            <i class=""><img src="../assets/img/pou.PNG"  ></i> </a></td>
