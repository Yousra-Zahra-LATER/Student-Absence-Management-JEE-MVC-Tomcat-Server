      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="http://localhost:8080/gestion/SlistedesExclus?iduser=${sessionScope.iduser}&name=${sessionScope.name}"> <i class="material-icons text-danger"> cancel </i> Afficher la liste des ecxlus de mes groupes</a></br>
          </div>
            ...
            <div class=" col-md-4">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">le module  </p>
                  <h3 class="card-title"><%= L.SelectionnerModule(rs1.getInt("idmodule"))%> <%=rs1.getString("type") %></h3>
                ...
                <div class="card-footer">
                  <div class="stats">
                   <i class=""><img src="../assets/img/vis.PNG"  ></i>
                    <a href="http://localhost:8080/gestion/SafficherlisteNombreAbsence?op=<%=  rs1.getString("type") %>&op1=<%=rs1.getInt("idmodule")%>&iduser=${sessionScope.id}&name=${sessionScope.name}"><h4> Consulter la liste des etudiants</h4></a>
                  </div>
                </div>
