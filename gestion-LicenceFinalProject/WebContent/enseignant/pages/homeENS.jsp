...
LocalDate localDate=localDateTime.toLocalDate();
      ...
      <div class="content">
         <div class="container-fluid">
          ...
          ResultSet rs1=stmt.executeQuery("select * from séance s,groupe g where s.idgroupe=g.idgroupe and s.idenseignant="+id2+" and jour='"+dayInFRench+"'");
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="http://localhost:8080/gestion/SafficherlisteFaireLappel?op=<%=  rs1.getInt("idséance") %>&op1=<%=rs1.getInt("idgroupe")  %>&iduser=${sessionScope.id}&name=${sessionScope.name}"><h4> Consulter <%=rs1.getString("nom") %> </h4></a>
                  </div>
                </div>
          ...
          ResultSet rs2=stmt.executeQuery("select * from séance s,section se where s.idsection=se.idsection  and s.idenseignant="+id2+" and jour='"+dayInFRench+"'" );
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="http://localhost:8080/gestion/SafficherlisteFaireLappelSection?op=<%=  rs2.getInt("idséance") %>&op1=<%=rs2.getInt("idsection")%>&iduser=${sessionScope.id}&name=${sessionScope.name}"> <h4> Consulter <%=rs2.getString("nom") %>  </h4></a>
                  </div>
                </div>
        ...
        <%
         ...
         <div class="table100 ver6 m-b-110">
           ...
           System.out.println(id1);
            String query="select * from séance where idenseignant="+id1
	  ...
	  <% try
    	...
    	String password="00000";
            ...
            String query="select * from séance where idenseignant="+id+" and jour='lundi' order by (heured); ";
	      ...
	      <tr class="row100">
            ...
            int id=h.selectIDens((Integer)session.getAttribute("id"));
            String query="select * from séance where idenseignant="+id+" and jour='mardi' order by (heured); ";
			 ...
			 <% try
            {
	         	...
	         	String password="00000";
            int id=h.selectIDens((Integer)session.getAttribute("id"));
            String query="select * from séance where idenseignant="+id+" and jour='mercredi' order by (heured); ";
			 ...
			 <% try
            {
	         	...
	         	String password="00000";
            int id=h.selectIDens((Integer)session.getAttribute("id"));
            String query="select * from séance where idenseignant="+id+" and jour='jeudi' order by (heured); ";
