...
<body class="">
  <div class="wrapper">
    <div class="sidebar" data-color="green" data-background-color="green" data-image="../assets/img/log.jpg">
    ...
    <div class="main-panel">
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" >les Séances</a></br>
          </div>
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          rs.next();
          int ide=rs.getInt("idEnseignant");
          ResultSet rs1=stmt.executeQuery("select * from séance s,groupe g where s.idgroupe=g.idgroupe and s.idenseignant="+ide);
              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="http://localhost:8080/gestion/SafficherlisteFaireLappel?op=<%=  rs1.getInt("idséance") %>&op1=<%=rs1.getInt("idgroupe")  %>&iduser=${sessionScope.iduser}&name=${sessionScope.name}"><h4> Consulter <%=rs1.getString("nom") %> </h4></a>
                  </div>
                </div>
          ...
          ResultSet rs2=stmt.executeQuery("select * from séance s,section se where s.idsection=se.idsection  and s.idenseignant="+ide );
